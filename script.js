const config = {
    publicKey: "-ZqbNnlOKiPFUgH7S", // Replace with actual EmailJS public key
    serviceId: "service_du9dmui", // Replace with actual service ID
    templateId: "template_blkkk5s" // Replace with actual template ID
};
